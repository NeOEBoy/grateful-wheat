...
class ProductionPlanPrinter extends React.Component {
    ...
    refresh = async (template, orderList) => {
        this.setState({ productSpinning: true, productionButtonText: '准备打印...' }, async () => {
            let allData = [];
            ...
            this.setState({ productSpinning: false, productionButtonText: '', allProductionDataToBePrint: allDataAfterA4 });
    ...
    render() {
        ...
        return (
            <Spin tip={productionButtonText} spinning={productSpinning} size='large'>
                <div>
